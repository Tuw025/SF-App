...
export default function AiSettingsModal({ onClose }: AiSettingsModalProps) {
  ...
  const MODELS = [
    ...
    { id: 'llama-3.1-70b-versatile', name: 'Llama 3.1 (70B)', type: 'free', desc: 'Đỉnh cao đa ngôn ngữ', tag: 'Miễn phí', provider: 'Groq' },
    { id: 'llama-3.1-8b-instant', name: 'Llama 3.1 (8B)', type: 'free', desc: 'Tốc độ siêu tốc', tag: 'Miễn phí', provider: 'Groq' },
